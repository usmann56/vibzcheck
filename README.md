...
Presentation: https://drive.google.com/file/d/1UHXmgmkhifxcHBOsZo4vUqFDFLExqoN9/view?usp=drive_link

AI Usage Log

2025-11-22–12-04, Initial Scaffolding: assisted with project route wiring, and theme setup.
2025-12-06–12-08, Floating Actions & Navigation: assisted by suggesting FAB placement, gesture navigation patterns, and streamlined navigation stack updates.
2025-12-08, Search Feature: assisted in structuring the token utility and search UI flow.
2025-12-08, Play Songs: assisted with the add-to-playlist flow and success/error UX.
...
2025-12-08, Screens Refactor: assisted with folder structure refactoring and import organization.
2025-12-09, User Profile: assisted with profile flows (username capture at registration, sign out flow).
...
2025-12-13, Default Playlist on Signup: assisted with a default playlist check and setting currentPlaylistId at user creation.
